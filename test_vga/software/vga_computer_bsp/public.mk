...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../vga_computer.sopcinfo
...
# Design Name 
# setting SOPC_NAME is vga_computer
SOPC_NAME := vga_computer
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4041040
SOPC_SYSID_FLAG += --sidp=0x4041040
ELF_PATCH_FLAG  += --sidp 0x4041040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1649691853
SOPC_SYSID_FLAG += --timestamp=1649691853
ELF_PATCH_FLAG  += --timestamp 1649691853
